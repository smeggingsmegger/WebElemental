...
class TestElemental(Elemental):
    """
    A class that extends Elemental and TestCase This class adds
    ...
    def __init__(self, base_url='http://127.0.0.1:5000', xvfb=True,
        ...
        Elemental.__init__(self, xvfb, driver, mootools, timeout, width, height,
